...
const ActionSchema = new Schema(
  {
    type: { type: String, enum: ['save_profile', 'add_cabinet', 'add_exercise_set', 'plan_exercise', 'save_injury', 'update_injury', 'save_training_goal', 'save_sport', 'update_focus_areas'], required: true },
